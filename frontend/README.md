...
1. **Set the API base URL** – In `.env.production` set `VITE_API_BASE_URL` to your Railway backend URL (e.g. `https://buysellclub-backend-production.up.railway.app`). Rebuild after changing.
