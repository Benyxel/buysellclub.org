        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-white space-y-6">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
              Direct Access to{" "}
              <span className="text-yellow-400">Verified Suppliers</span> in China
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              <div className="flex items-start gap-3">
                <FaCheckCircle className="text-yellow-400 text-xl mt-1 flex-shrink-0" />
                <div>
            ...
            <div className="pt-4">
              <Link
                to="/Suppliers"
                className="inline-flex items-center gap-2 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold px-8 py-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
