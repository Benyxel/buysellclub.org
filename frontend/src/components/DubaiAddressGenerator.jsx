        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
          <div className="bg-primary/10 dark:bg-primary/20 p-8 text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              Dubai Address Generator
            </h1>
            <p className="text-gray-600 dark:text-gray-400">
              Generate your unique shipping address for our Dubai / UAE warehouse
            </p>
          </div>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-blue-800 dark:text-blue-200 text-sm">
                        Your shipping mark is shared across China, USA, and Dubai. If you already generated a China address, you can view your Dubai format here.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mb-8">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-green-800 dark:text-green-200 text-sm">
                        Your Dubai warehouse address is below. Use this when shipping to our Dubai / UAE warehouse.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-600 overflow-hidden">
                  ...
                  <div className="p-4 sm:p-6 space-y-4">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Full Dubai / UAE address</p>
                      <div className="relative">
                        <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                          <p className="text-sm text-gray-900 dark:text-white break-all whitespace-pre-line">{fullAddressDubai}</p>
                        </div>
                        <button
                          type="button"
                          onClick={() => copyToClipboard("full", fullAddressDubai)}
                          className="absolute top-3 right-3 p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
                        >
...
export default DubaiAddressGenerator;
