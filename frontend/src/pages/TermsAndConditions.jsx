      ...
      content: (
        <div className="space-y-4">
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            By accessing and using BuySellClub's platform, services, website,
            mobile applications, and any related services (collectively, the
            "Service"), you acknowledge that you have read, understood, and
            agree to be bound by these Terms and Conditions ("Terms"). These
            Terms constitute a legally binding agreement between you ("User",
            "you", or "your") and BuySellClub ("Company", "we", "us", or "our").
          </p>
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 p-4 rounded">
            <p className="text-sm text-gray-700 dark:text-gray-300">
              <strong>Important:</strong> If you do not agree to these Terms,
              you must immediately discontinue use of the Service. Your
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            and/or contributors of content. By using our Service, you represent
            that you are at least 18 years of age or have obtained parental
          ...
          <dl className="space-y-3">
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded">
              ...
              <dd className="text-gray-700 dark:text-gray-300 text-sm">
                Refers to all services provided by BuySellClub, including but
                not limited to e-commerce platform, shipping and logistics,
                Buy4Me procurement, payment processing, training services, and
                any related applications or tools.
              </dd>
            </div>
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded">
              <dt className="font-semibold text-gray-900 dark:text-white mb-1">
              ...
              <dd className="text-gray-700 dark:text-gray-300 text-sm">
                The account created by you to access and use the Service,
                including all associated credentials, personal information, and
                transaction history.
              </dd>
            </div>
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded">
              ...
              <dd className="text-gray-700 dark:text-gray-300 text-sm">
                Any information, data, text, graphics, images, videos, audio
                files, software, or other materials posted, uploaded, or
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded">
              ...
              <dd className="text-gray-700 dark:text-gray-300 text-sm">
                All trademarks, service marks, logos, trade names, copyrights,
                patents, trade secrets, and other intellectual property rights
                owned or licensed by BuySellClub.
              </dd>
            </div>
          </dl>
        </div>
      ...
      content: (
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <li>
              Ensure that you are authorized to use the payment method(s)
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
            <li>
              Use a strong, unique password that you do not use for other online
              accounts
            </li>
            <li>Enable two-factor authentication when available</li>
            <li>Not share your account credentials with any third party</li>
            <li>
              Log out from your account at the end of each session, especially
          ...
          <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-400 p-4 rounded mt-4">
            <p className="text-sm text-gray-700 dark:text-gray-300">
              <strong>Warning:</strong> BuySellClub will not be liable for any
              loss or damage arising from your failure to comply with these
              security obligations. You may be held liable for losses incurred
              by BuySellClub or any other user due to unauthorized use of your
              account.
            </p>
          </div>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
            <li>
              <strong>E-Commerce Services:</strong> Online marketplace for
              purchasing products from China and international suppliers
            </li>
            <li>
              <strong>Shipping & Logistics:</strong> Freight forwarding,
              warehousing, and delivery services from China to Ghana
            </li>
            <li>
              <strong>Buy4Me Services:</strong> Custom procurement and sourcing
              services for specific product requests
            </li>
            <li>
              <strong>Payment Processing:</strong> Secure payment processing
              including Alipay integration and cross-border transactions
            </li>
            <li>
              <strong>Training & Education:</strong> Educational courses and
              training materials related to import/export business
            </li>
          </ul>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            We strive to provide continuous access to our Service, but we do not
            guarantee uninterrupted, secure, or error-free operation. The
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded border-l-4 border-red-400">
              ...
              <ul className="list-disc pl-6 space-y-1 text-sm text-gray-700 dark:text-gray-300">
                ...
                <li>
                  Import or export prohibited items (weapons, drugs, counterfeit
                  goods, etc.)
                </li>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded border-l-4 border-blue-400">
              ...
              <ul className="list-disc pl-6 space-y-1 text-sm text-gray-700 dark:text-gray-300">
                ...
                <li>
                  Engage in any activity that could harm our business reputation
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-400 p-4 rounded mt-4">
            <p className="text-sm text-gray-700 dark:text-gray-300">
              <strong>Consequences:</strong> Violation of these prohibitions may
              result in immediate account suspension or termination, legal
              action, and reporting to relevant authorities. We reserve the
              right to investigate and prosecute violations to the fullest
              extent of the law.
            </p>
          </div>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            All payments must be made through approved payment methods. You
            agree to:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
            <li>Provide valid payment information</li>
            <li>
              Authorize BuySellClub to charge your payment method for all fees
              and charges
            </li>
            <li>
              Pay all applicable fees, taxes, and charges in a timely manner
            </li>
            <li>
              Understand that prices may change without notice, but orders are
              confirmed at the price at time of purchase
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
            <li>
              <strong>Transaction Fees:</strong> Applied to purchases and
              service orders
            </li>
            <li>
              <strong>Shipping Fees:</strong> Calculated based on weight,
              dimensions, and destination
            </li>
            <li>
              <strong>Service Fees:</strong> For Buy4Me, training, and premium
              services
            </li>
            <li>
              <strong>Currency Conversion Fees:</strong> Applied to cross-border
              transactions
            </li>
            <li>
              <strong>Processing Fees:</strong> For payment processing and
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
            <li>
              <strong>Product Orders:</strong> Subject to our return policy
              (typically 72 hours after pickup)
            </li>
            <li>
              <strong>Buy4Me Services:</strong> Refundable if procurement fails
              or service is not delivered as specified
            </li>
            <li>
              <strong>Training Courses:</strong> Refundable if course is
              cancelled or rescheduled beyond 7 days
            </li>
            <li>
              <strong>Shipping Services:</strong> Non-refundable once shipment
              is in transit, except for service failures
            </li>
          </ul>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
            All refund requests must be submitted within the applicable
            timeframes and are subject to review and approval. Processing fees
      ...
      content: (
        <div className="space-y-4">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            exclusive property of BuySellClub or its content suppliers and are
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
            <li>
              Access and use the Service for personal or commercial purposes in
              accordance with these Terms
            </li>
            <li>
              Download or print content for your personal, non-commercial use
            </li>
          </ul>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <li>
              Use data mining, robots, or similar data gathering and extraction
              tools
            </li>
          </ul>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            By posting, uploading, or submitting content to the Service, you
            grant BuySellClub a worldwide, royalty-free, perpetual, irrevocable,
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, BUYSELLCLUB SHALL NOT BE
            LIABLE FOR:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
            <li>
            ...
            <li>
              Damages resulting from delays, shipping issues, or customs
              problems
            </li>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            the Service shall not exceed the amount you paid to us in the twelve
            (12) months preceding the claim, or GHS 10,000, whichever is
            greater.
          </p>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            disasters, war, terrorism, labor disputes, government actions, or
      ...
      content: (
        <div className="space-y-4">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            team or using the account deletion feature in your account settings.
            Upon termination:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <li>
              We may delete or anonymize your account data in accordance with
              our Privacy Policy
            </li>
            <li>
      ...
      content: (
        <div className="space-y-4">
          ...
          <ol className="list-decimal pl-6 space-y-2 text-gray-700 dark:text-gray-300">
            <li>
              <strong>Informal Negotiation:</strong> Attempt to resolve disputes
              through good faith negotiation for 30 days
            </li>
            <li>
              <strong>Mediation:</strong> If negotiation fails, engage in
              mediation through a mutually agreed mediator
            </li>
            <li>
              <strong>Arbitration:</strong> If mediation fails, disputes shall
              be resolved through binding arbitration under Ghana ADR Act
            </li>
            <li>
              <strong>Court Proceedings:</strong> Only as a last resort or for
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            You agree that any disputes will be resolved individually and not as
            part of a class, consolidated, or representative action. You waive
            any right to participate in class action lawsuits or class-wide
            arbitrations.
          </p>
        </div>
      ),
      ...
      content: (
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <li>
              Sending an email notification to the email address associated with
              your account
            </li>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
            ...
            the modified Terms, you must stop using the Service and may
            terminate your account.
          </p>
          <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-400 p-4 rounded mt-4">
            <p className="text-sm text-gray-700 dark:text-gray-300">
              <strong>Recommendation:</strong> We encourage you to review these
              Terms periodically to stay informed of any updates. Material
              changes will be effective 30 days after notification, unless
              immediate changes are required by law.
            </p>
          </div>
        </div>
      ),
      ...
      content: (
        <div className="space-y-4">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            between you and BuySellClub regarding the Service.
          </p>
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            not constitute a waiver of such right or provision unless
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            employment, or agency relationship between you and BuySellClub.
          </p>
        </div>
      ),
    },
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-6">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              BuySellClub's services. These Terms govern your access to and use
              of our platform, services, and website. By creating an account or
        ...
        <div className="mt-8 bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl shadow-lg p-8 border border-primary/20">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
            ...
            these Terms and Conditions, please don't hesitate to contact our
            legal team. We're here to help.
          </p>
        ...
        <div className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
          <p>
            By using BuySellClub's services, you acknowledge that you have read,
