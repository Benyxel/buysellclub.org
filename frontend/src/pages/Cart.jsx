                  ...
                  <div className="flex items-start gap">
                    ...
                    <div>
                      ...
                      {availableInventory !== null && (
                        <p className="mx-6 mt-1 text-xs sm:text-sm text-gray-500">
                  ...
                  <div className="flex flex-col items-center gap-1">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        // Check if value exceeds available inventory
                        if (maxQuantity !== null && numValue > maxQuantity) {
                          toast.warning(`Only ${availableInventory} item(s) available in stock. Maximum quantity set to ${maxQuantity}.`);
                          updateQuantity(item._id, item.size, maxQuantity);
                          return;
                        }
