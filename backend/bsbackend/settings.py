...
SECRET_KEY = "django-insecure-m3%oqa)#$k5-3rg$#1@6!ycwne$*c2o_=r0s+vdb&4&60a22%3"
...
# If you make state-changing requests from the frontend, this helps with CSRF in dev
...
# Django REST Framework basic setup (JWT optional)
REST_FRAMEWORK = {
